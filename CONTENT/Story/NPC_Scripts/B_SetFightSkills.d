...
func void B_SetFightSkills (var C_NPC slf, var int percent)
{
	...
	B_RaiseRealFightTalentPercent (slf, NPC_TALENT_1H, 		percent);
	B_RaiseFightTalent (slf, NPC_TALENT_1H, 		percent);
	B_RaiseRealFightTalentPercent (slf, NPC_TALENT_2H, 		percent);
	B_RaiseFightTalent (slf, NPC_TALENT_2H, 		percent);
	B_RaiseRealFightTalentPercent (slf, NPC_TALENT_BOW, 		percent);
	B_RaiseFightTalent (slf, NPC_TALENT_BOW, 		percent);
	B_RaiseRealFightTalentPercent (slf, NPC_TALENT_CROSSBOW,	percent);

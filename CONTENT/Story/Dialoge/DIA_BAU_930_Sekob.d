...
func void DIA_Sekob_Again_Info ()
{
	...
	{
		Info_AddChoice	(DIA_Sekob_Again, "Ja.", DIA_Sekob_Again_Ja);
	};
};
...
{
	AI_Output (other, self, "DIA_Sekob_Again_Ja_15_00"); //Ja.
...
func void DIA_Sekob_Again_verarscht()
{
	...
	AI_Output (self, other, "DIA_Sekob_Again_verarscht_01_01"); //Und? Was sagt er?
...
{
	AI_Output			(other, self, "DIA_Sekob_DMTWEG_15_00"); //Dein Haus ist leer.
...
func void DIA_Sekob_BELOHNUNG_Info ()
{
	...
	AI_Output			(self, other, "DIA_Sekob_BELOHNUNG_01_10"); //Hier ist es.
...
{
	AI_Output			(other, self, "DIA_Sekob_ROSINEVERBACK_15_00"); //Rosi wird nicht zu dir zurückkommen.

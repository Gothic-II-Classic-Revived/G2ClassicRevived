...
INSTANCE DIA_Cassia_Ablehnen   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Und was, wenn ich mich euch nicht anschließen will...?";
};
...
{
	AI_Output (other, self, "DIA_Cassia_Ablehnen_15_00");//Und was, wenn ich mich euch nicht anschließen will...?
...
{
	AI_Output (other, self, "DIA_Cassia_BevorLernen_15_00");//Kannst du mich trainieren?
	...
	else
	{
		...
		Info_AddChoice 	  (DIA_Cassia_BevorLernen,"Vielleicht später...(ZURÜCK)",DIA_Cassia_BevorLernen_Spaeter);

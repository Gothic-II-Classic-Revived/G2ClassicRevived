...
{
	AI_Output (other,self ,"DIA_Godar_ComeFrom_Bandits_KeepCalm_15_00"); //Entspann dich. Ich verpfeiff dich nicht.
...
FUNC VOID DIA_Godar_ComeFrom_Bandits_NoFear ()
{
	...
	AI_Output (self ,other,"DIA_Godar_ComeFrom_Bandits_NoFear_13_01"); //Wir werden sehen.
...
FUNC VOID DIA_Godar_ComeFrom_NotCity_Forget ()
{
	...
	AI_Output (self ,other,"DIA_Godar_ComeFrom_NotCity_Forget_13_01"); //Stimmt genau.
...
{
	AI_Output (other,self ,"DIA_Godar_ComeFrom_NotCity_CutThroat_15_00"); //Nein.
...
{
	AI_Output (other,self ,"DIA_Godar_Plan_15_00"); //Was machst du hier?
...
{
	AI_Output (other,self ,"DIA_Godar_Hunting_15_00"); //Kannst du mir das Jagen beibringen?
...
func void DIA_Godar_Dragonstuff_nein ()
{
	...
	AI_Output			(self, other, "DIA_Godar_Dragonstuff_nein_13_01"); //Wie du willst.
	Info_ClearChoices	(DIA_Godar_Dragonstuff);	

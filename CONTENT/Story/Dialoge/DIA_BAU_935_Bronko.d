...
{
	AI_Output			(other, self, "DIA_Bronko_HALLO_hiergeld_15_00"); //Wenn´s sein muß, hier hast du dein Geld.
...
{
	AI_Output			(other, self, "DIA_Bronko_KEINBAUER_15_00"); //Du willst der Bauer sein? Dass ich nicht lache.
...
{
	AI_Output			(other, self, "DIA_Bronko_KEINBAUER_attack_15_00"); //Na dann laß mal sehen, was du drauf hast.
...
func void DIA_Bronko_KEINBAUER_schongut ()
{
	...
	AI_Output			(self, other, "DIA_Bronko_KEINBAUER_schongut_06_01"); //Verschwinde!
...
func void DIA_Bronko_KEINBAUER_SLD ()
{
	...
	AI_Output			(other, self, "DIA_Bronko_KEINBAUER_SLD_15_02"); //Und?

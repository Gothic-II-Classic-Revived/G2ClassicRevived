...
{
	AI_Output (other,self ,"DIA_Dyrian_HowIsIt_15_00"); //Wie läuft's denn so?
};
...
{
	AI_Output (other,self ,"DIA_Dyrian_Kneipe_15_00"); //Wie läuft's denn so?
...
{
	AI_Output (other,self ,"DIA_Dyrian_nachher_15_00"); //Wie steht's?

...
func void DIA_Harad_Taugenichts_Info ()
{
	...
	AI_Output (other, self, "DIA_Harad_Taugenichts_15_02"); //Worauf willst du hinaus?
...
func void DIA_Harad_OrcSuccess_Info ()
{
	...
	AI_Output (self, other, "DIA_Harad_OrcSuccess_12_01"); //Zeig mal her...
...
func void DIA_Harad_SellBlades_Info ()
{
	...
	else //(gesamt >= 1) - die verbeliebenden Klingen verkaufen ------
	{
		...
		Npc_RemoveInvItems (other, ITMW_REVIVED_2H_SWORD_SMITH_05, anzahl_2hsword5);
				...
				concatText = ConcatStrings(IntToString(gesamt), PRINT_ItemsGegeben);		// "x Gegenstnde gegeben"
...
func void B_HaradSmithChoices()
{
	...
	{
		Info_AddChoice	(DIA_Harad_TeachSmith, B_BuildLearnString("Lerne, Schwerter zu schmieden"	   , B_GetLearnCostTalent(other, NPC_TALENT_SMITH, WEAPON_Common))			,DIA_Harad_TeachSmith_Common);
	};
};
// ------------------------------------------------------------
...
{
	AI_Output (other, self, "DIA_Harad_TeachCommon_15_00"); //Bring mir bei, wie man ein ordentliches Schwert schmiedet!
...
// *****************************************************
// 					Ich mchte eine Erzklinge kaufen
// *****************************************************

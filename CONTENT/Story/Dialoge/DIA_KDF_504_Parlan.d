...
FUNC VOID DIA_Parlan_PETZMASTER_Info()
{
	...
	Parlan_Schulden = 0; //weil Funktion nochmal durchlaufen wird, wenn Crime hher ist...
	...
	if (B_GetGreatestPetzCrime(self) == CRIME_MURDER) 
	{
		...
		Parlan_Schulden = Parlan_Schulden + 500;						//PLUS Mrder-Malus
...
func void DIA_Parlan_Amulett_Info ()
{
	...
	AI_Output (self, other, "DIA_Parlan_Amulett_05_02"); //Er wurde erschaffen, um uns vor den Mächten des Bösen zu schützen, wenn die Zeit gekommen ist.
};
///////////////////////////////////////////////////////////////////////
//	Info Hagen
///////////////////////////////////////////////////////////////////////
...
FUNC VOID DIA_Parlan_Kap3U4U5_PERM_Church()
{
	...
	//AI_Output (self ,other,"DIA_Parlan_Kap3U4U5_PERM_Church_05_01"); //Die Kirche ist das grte Gebude im Kloster. Du kannst sie gar nicht bersehen.
...
FUNC VOID DIA_Parlan_Kap3U4U5_PERM_Library()
{
	...
	//AI_Output (self ,other,"DIA_Parlan_Kap3U4U5_PERM_Library_05_01"); //Die Bibliothek ist am Ende des Sulenganges, direkt gegenber der Kirche.
...
FUNC VOID DIA_Parlan_Kap3U4U5_PERM_Chapel()
{
	...
	//AI_Output (self ,other,"DIA_Parlan_Kap3U4U5_PERM_Chapel_05_01"); //Wenn du das Kloster betrittst, findest du die Kapelle auf der halben Hhe des linken Sulenganges.
...
FUNC VOID DIA_Parlan_Kap3U4U5_PERM_Cellar()
{
	...
	//AI_Output (self ,other,"DIA_Parlan_Kap3U4U5_PERM_Cellar_05_01"); //Der Eingang in die Katakomben ist direkt gegenber der Kapelle auf halber Hhe des Sulenganges.

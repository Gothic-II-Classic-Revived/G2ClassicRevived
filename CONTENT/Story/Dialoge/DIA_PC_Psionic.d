...
{	
	AI_Output	(other, self,"DIA_Lester_WhatHappened_15_00");	//Was ist geschehen?
...
func void DIA_Lester_BACKINTOWN_Info ()
{
	...
	AI_StopProcessInfos (self);
	Npc_ExchangeRoutine (self,"XardasLibrary");	//Joly: Lester geht wieder zurck in sein Tal!
};
...
{
	AI_Output			(other, self, "DIA_Lester_KnowWhereEnemy_15_00"); //Ich habe herausgefunden, wo sich der Feínd versteckt.
	AI_Output			(self, other, "DIA_Lester_KnowWhereEnemy_13_01"); //Frag mich nicht, wieso, aber ich spüre, dass ich dich begleiten sollte.
	AI_Output			(other, self, "DIA_Lester_KnowWhereEnemy_15_02"); //Was soll das heißen?
...
{	
	if ((Lester_IsOnBOard == LOG_OBSOLETE)		//Hier brauch man natrlich nur eine variable abfragen
...
INSTANCE DIA_PC_Psionic_PICKPOCKET (C_INFO)
{
	...
	permanent	= TRUE;
	description = "(It will be easy to steal his key.)";
};                       

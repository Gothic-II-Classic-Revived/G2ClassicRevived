...
{	
	AI_Output (other,self ,"DIA_Hanna_AnyNews_15_00"); //Wie läuft's denn so?
...
{
	AI_Output (other,self ,"DIA_Hanna_AnyNews_No_15_00"); //Nicht wirklich.
...
{
	AI_Output (other,self ,"DIA_Hanna_AnyNews_Depends_15_00"); //Kommt drauf an.
...
{
	AI_Output (other,self ,"DIA_Hanna_AnyNews_Yes_15_00"); //Ja ja.
...
{
	AI_Output (other,self ,"DIA_Hanna_AnyNews_Yes_Reward_15_00"); //Was springt für mich dabei	raus?
...
{
	AI_Output (other,self ,"DIA_Hanna_AnyNews_Yes_WillSee_15_00"); //Werd' sehen was ich rausfinden kann.
...
{	
	...
	AI_Output (other, self, "DIA_Hanna_Add_15_43"); //Nun ...

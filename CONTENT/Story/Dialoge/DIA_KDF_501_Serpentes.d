...
{
	AI_Output (other, self, "DIA_Serpentes_NOIDEA_15_00"); //Lebender Fels...? Was für ein Wesen wäre das denn?
...
func void DIA_Serpentes_SUCCESS_Info ()
{
	...
	if (Npc_HasItems (other, ITMW_REVIVED_1H_HAMMER_HOLY) >= 1)
	{
		AI_Output (self, other, "DIA_Serpentes_SUCCESS_10_05"); //Und den Hammer nehme ich mal besser an mich.
		
		Npc_RemoveInvItems (other, ITMW_REVIVED_1H_HAMMER_HOLY,1); 
		Wld_InsertItem (ITMW_REVIVED_1H_HAMMER_HOLY,"FP_HAMMER");
	};
...
{
	AI_Output			(other, self, "DIA_Serpentes_MinenAnteile_nein_15_00"); //Ich habe schon genug zu tun. Sucht dir jemand anderen.

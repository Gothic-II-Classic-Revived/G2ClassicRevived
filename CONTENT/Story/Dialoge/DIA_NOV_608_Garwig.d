...
{	
	AI_Output (other, self, "DIA_Garwig_Wurst_15_00"); //Willst du 'ne Wurst?
...
{
	AI_Output			(other, self, "DIA_Garwig_SLEEP_AGAIN_15_00"); //Du schläfst wirklich NIE?
...
{	
	...
	&&  (Npc_HasItems (hero, ITMW_REVIVED_1H_HAMMER_HOLY) == 1)
	{
		return TRUE;
	};
};

...
{
	AI_Output (other, self, "DIA_Rod_Wette_Yes_15_00"); //Ja.
	...
	if (B_GiveInvItems (other,self, itmi_gold, 30))
	{
		...
		Info_AddChoice (DIA_Rod_Wette, "Hier hast du es.", DIA_Rod_Wette_GiveBack);
	}
	else
	{
...
func void DIA_Rod_Wette_GiveBack()
{
	...
	AI_Output (other, self, "DIA_Rod_Wette_GiveBack_15_00"); //Hier hast du es.
	Info_ClearChoices (DIA_Rod_Wette);

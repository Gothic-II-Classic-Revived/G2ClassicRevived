...
func void DIA_BDT_1020_Wegelagerer_FirstWarn_Info()
{
	...
	self.aivar[AIV_Guardpassage_Status]	= GP_FirstWarnGiven;
 	...
 	Info_AddChoice (DIA_BDT_1020_Wegelagerer_FirstWarn,"Wie viel willst du?",DIA_BDT_1020_Wegelagerer_FirstWarn_HowMuch);
 	Info_AddChoice (DIA_BDT_1020_Wegelagerer_FirstWarn,"Du machst Witze.",DIA_BDT_1020_Wegelagerer_FirstWarn_Joke);
 	Info_AddChoice (DIA_BDT_1020_Wegelagerer_FirstWarn,"Mach Platz!",DIA_BDT_1020_Wegelagerer_PissOff);
...
{
	AI_Output (other,self ,"DIA_BDT_1020_Wegelagerer_PissOff_15_00"); //Mach Platz!
...
FUNC VOID DIA_BDT_1020_Wegelagerer_FirstWarn_NoMoney ()
{
	...
	if Npc_HasEquippedMeleeWeapon (other)
	{
		...
		Info_ClearChoices (DIA_BDT_1020_Wegelagerer_FirstWarn);
		Info_AddChoice (DIA_BDT_1020_Wegelagerer_FirstWarn,"Vergiß es.",DIA_BDT_1020_Wegelagerer_FirstWarn_NoWeapon);
...
{
	AI_Output (other,self ,"DIA_BDT_1020_Wegelagerer_FirstWarn_NoWeapon_15_00"); //Vergiß es.
...
func void DIA_BDT_1020_Wegelagerer_SecondWarn_Info()
{
	...
	if (Npc_HasItems (other,ItMi_gold) >= 20)
	{
		Info_AddChoice (DIA_BDT_1020_Wegelagerer_SecondWarn,"Hier hast du das Geld.",DIA_BDT_1020_Wegelagerer_SecondWarn_GiveMoney);
	};
...
FUNC VOID DIA_BDT_1020_Wegelagerer_SecondWarn_GiveMoney ()
{
	...
	AI_Output (other,self ,"DIA_BDT_1020_Wegelagerer_SecondWarn_GiveMoney_15_00"); //Hier hast du das Geld.

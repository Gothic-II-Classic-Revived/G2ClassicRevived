...
// -----------------------------------------------------------
	const string Mil_310_Checkpoint	= "NW_CITY_ENTRANCE_MAIN";	//WP hinter dem Stadttor vom Spielstart aus!
// -----------------------------------------------------------
...
func void DIA_Mil_310_Stadtwache_FirstWarn_Info()
{
	...
	else // ------ normales Reinkommen ------
	{
		...
		&& (hero.guild == GIL_NONE) 
		{
			AI_Output (other, self,"DIA_Mil_310_Stadtwache_FirstWarn_15_07"); //Was?
...
func void DIA_Mil_310_Stadtwache_Bribe_Info()
{
	...
	if (B_GiveInvItems (other, self, itmi_gold, 100))
	{
		...
		// ------ wenn bezahlt, persnliche Absolution erteilen -------
...
FUNC VOID DIA_Mil_310_Stadtwache_Passierschein_Info()
{
	...
	if (Npc_HasEquippedArmor(other) == FALSE) //ohne Rstung
	{
...
// ************************************************************
// 				Wichtige Nachricht fr Paladine
// ************************************************************
...
{
	AI_Output (other, self,"DIA_Mil_310_Stadtwache_Paladine_NoDragons_15_00"); //Nein. Aber ich weiß, daß sie von Drachen angeführt wird!
...
func void DIA_Mil_310_Stadtwache_Paladine_YesDragons() //+3
{
	...
	AI_Output (self, other,"DIA_Mil_310_Stadtwache_Paladine_YesDragons_07_02"); //Raus hier!
...
{
	AI_Output (other, self,"DIA_Mil_310_Stadtwache_Paladine_DepecheDragons_15_00"); //Die Armee des Bösen wird von Drachen angeführt!

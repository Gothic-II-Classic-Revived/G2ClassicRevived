...
FUNC VOID DIA_Talbin_AskTeacher_Info()
{
	...
	AI_Output(other,self,"DIA_Talbin_AskTeacher_15_02"); //Was willst du dafür?
	...
	AI_Output(other,self,"DIA_Talbin_AskTeacher_15_04"); //Werd' sehen was ich rausfinden kann.
...
func void DIA_Talbin_TEACHHUNTING_Info ()
{
	AI_Output			(other, self, "DIA_Talbin_TEACHHUNTING_15_00"); //Was kannst du mir beibringen?
			...
			)
		{
			...
			{ 
				Info_AddChoice	(DIA_Talbin_TEACHHUNTING, B_BuildLearnString ("Fell",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Fur)),  DIA_Talbin_TEACHHUNTING_Fur);
			};

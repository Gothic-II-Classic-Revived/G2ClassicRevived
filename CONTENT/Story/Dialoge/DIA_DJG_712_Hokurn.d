...
{
	AI_Output (other,self ,"DIA_Hokurn_Hello_No_15_00"); //Ich versuch was zu besorgen.
...
{
	AI_Output (other,self ,"DIA_Hokurn_StayHere_15_00"); //Was machst du denn hier?
...
{
	AI_Output (other,self ,"DIA_Hokurn_WhereDragon_FindMyself_15_00"); //Gar nichts, ich werde sie selber suchen.
...
{
	AI_Output (other,self ,"DIA_Hokurn_WhereDragon_OK_15_00"); //Einverstanden, hier ist da Geld.
...
{
	AI_Output (other,self ,"DIA_Hokurn_WhereDragon_Booze_15_00"); //Ich hab noch ne Flasche Wacholder.

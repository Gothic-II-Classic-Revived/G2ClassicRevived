...
///   													XXXXXXXXXXXXXXXXXXXXXXXXXXXXX
///   													XX  L A R G E   F I R E   S T O R M  XX
///   													XXXXXXXXXXXXXXXXXXXXXXXXXXXXX


INSTANCE spellFX_LargeFireStorm (CFx_Base_Proto)
{
		...
		emTrjOriginNode 		= "ZS_RIGHTHAND";
     	...
     	emActionCollStat_S		= "COLLIDE CREATEONCE CREATEQUAD";
     	emActionCollDyn_S 		= "COLLIDE CREATEONCE";
		emFXCollStat_S	   		= "spellFX_LargeFireStorm_SPREAD";
		emFXCollDyn_S     		= "spellFX_LargeFireStorm_SPREAD";
		emFXCollDynPerc_S     	= "vob_magicburn";
		emTrjTargetRange	 	= 20;
		emTrjTargetElev 		= 0;
		emTrjDynUpdateDelay		= 20000;
		emFXInvestORIGIN_S 		= "spellFX_LargeFireStorm_INVESTSOUND";
		...
		INSTANCE spellFX_LargeFireStorm_KEY_OPEN(C_ParticleFXEmitKey)
		{
				lightrange			= 0.01;
		};

		INSTANCE spellFX_LargeFireStorm_KEY_INIT (C_ParticleFXEmitKey)
		{
				lightrange			= 0.01;
		};

		INSTANCE spellFX_LargeFireStorm_KEY_INVEST_1	(C_ParticleFXEmitKey)	{	lightrange	= 100;	emCreateFXID	= "spellFX_LargeFireStorm_INVESTBLAST1";	};
		INSTANCE spellFX_LargeFireStorm_KEY_INVEST_2	(C_ParticleFXEmitKey)	{	lightrange	= 150;	emCreateFXID	= "spellFX_LargeFireStorm_INVESTBLAST2";	};
		INSTANCE spellFX_LargeFireStorm_KEY_INVEST_3	(C_ParticleFXEmitKey)	{	lightrange	= 200;	emCreateFXID	= "spellFX_LargeFireStorm_INVESTBLAST3";	};
		INSTANCE spellFX_LargeFireStorm_KEY_INVEST_4	(C_ParticleFXEmitKey)	{	lightrange	= 250;	emCreateFXID	= "spellFX_LargeFireStorm_INVESTBLAST4";	};

		INSTANCE spellFX_LargeFireStorm_KEY_CAST (C_ParticleFXEmitKey)
		{
				visname_S 				= "MFX_Firestorm_CAST";
				emtrjmode_s 			= "TARGET";
		     	emtrjeasevel 			= 1400.;
		...
		INSTANCE spellFX_LargeFireStorm_KEY_COLLIDE (C_ParticleFXEmitKey)
		{
		     	pfx_flygravity_s		= "0 0.0002 0";
		     	emtrjeasevel 			= 0.000001;
};
...
INSTANCE spellFX_LargeFireStorm_INVESTSOUND	(CFX_Base_Proto)
{
		visname_s		= "simpleglow.tga";
		visalpha		= 0.01;
		sfxid			= "MFX_Firestorm_Invest";
...
INSTANCE spellFX_LargeFireStorm_INVESTBLAST1	(CFX_Base_Proto)
{
		visname_S 		= "MFX_Firestorm_INVESTBLAST1";
		emtrjmode_s 	= "FIXED";
		sfxid			= "MFX_Fireball_invest1";
...
INSTANCE spellFX_LargeFireStorm_INVESTBLAST2	(CFX_Base_Proto)
{
		visname_S 		= "MFX_Firestorm_INVESTBLAST2";
		emtrjmode_s 	= "FIXED";
		sfxid			= "MFX_Fireball_invest2";
...
INSTANCE spellFX_LargeFireStorm_INVESTBLAST3	(CFX_Base_Proto)
{
		visname_S 		= "MFX_Firestorm_INVESTBLAST3";
		emtrjmode_s 	= "FIXED";
		sfxid			= "MFX_Fireball_invest3";
...
INSTANCE spellFX_LargeFireStorm_INVESTBLAST4	(CFX_Base_Proto)
{
		visname_S 		= "MFX_Firestorm_INVESTBLAST4";
		emtrjmode_s 	= "FIXED";
		sfxid			= "MFX_Fireball_invest4";
...
INSTANCE spellFX_LargeFireStorm_SPREAD	(CFx_Base_Proto)
{
		...
		INSTANCE spellFX_LargeFireStorm_SPREAD_KEY_INIT (C_ParticleFXEmitKey)
		{
				lightrange 				= 0.001;
		};

		INSTANCE spellFX_LargeFireStorm_SPREAD_KEY_CAST (C_ParticleFXEmitKey)
		{
				lightrange 				= 150;
};
...
INSTANCE spellFX_FireWave(CFx_Base_Proto)
{
        ...
        emTrjOriginNode     = "ZS_RIGHTHAND";
        emtrjloopmode_s     = "NONE";
        emFXInvestOrigin_S  = "spellFX_FireWave_Invest";
};
...
{
        emCreateFXID        = "spellFX_FireWave_WAVE";
        pfx_ppsIsLoopingChg = 1;
        sfxid               = "MFX_Firestorm_Cast";
        sfxisambient        = 1;
};
...
INSTANCE spellFX_FireWave_WAVE(CFx_Base_Proto)
{
        ...
        emTrjOriginNode     = "ZS_RIGHTHAND";
        emActionCollDyn_S   = "CREATEONCE";
        emFXCollDynPerc_S   = "spellFX_FireWave_SENDPERCEPTION";
        emFXCollDynAlign_S  = "COLLISIONNORMAL";
        emCheckCollision    = 1;
        LightPresetName     = "FIRESMALL";
};
...
INSTANCE spellFX_FireWave_SENDPERCEPTION (CFx_Base_Proto)
{
        visname_S           = "";
        sendAssessMagic     = 1;
};

INSTANCE spellFX_FireWave_Invest (CFx_Base_Proto)
{
        visname_S           = "MFX_FireRain_INVESTGLOW";
        emTrjOriginNode     = "BIP01";
        emFXCreatedOwnTrj   = 1;
...
INSTANCE spellFX_FireFist(CFx_Base_Proto)
{
        ...
        emFXInvestOrigin_S  = "spellFX_FireFist_Invest";
};
...
{
        visname_S           = "MFX_FIREFIST_COLLISIONDUMMY";
        emtrjmode_s         = "TARGET";
        emtrjeasevel        = 2500.;
        emCheckCollision    = 1;
        emCreateFXID        = "spellFX_FIREFIST_CAST";
};

INSTANCE spellFX_FireFist_Invest (CFx_Base_Proto)
{
        visname_S           = "MFX_FIREFIST_INVEST";
        sfxid               = "MFX_WINDFIST_INVEST";
        sfxisambient        = 1;
};

INSTANCE spellFX_FireFist_INVESTBLAST (CFX_Base_Proto)
{
        visname_S           = "MFX_FIREFIST_INVEST_BLAST";
        sfxid               = "MFX_WINDFIST_INVESBLAST";
        sfxisambient        = 1;
};

INSTANCE spellFX_FireFist_Cast (CFx_Base_Proto)
{
...
INSTANCE spellFX_Explode (CFx_Base_Proto)
{
    visname_S               = "MFX_Explode_INIT";
    emtrjmode_s             = "FIXED";
    emTrjOriginNode         = "ZS_RIGHTHAND";
    emtrjtargetnode         = "BIP01 FIRE";
    emtrjloopmode_s         = "NONE";
    ...
    emActionCollStat_S      = "COLLIDE CREATEONCE CREATEQUAD";
    emActionCollDyn_S       = "COLLIDE CREATEONCE";
    emFXCollStat_S          = "spellFX_BeliarsRage_COLLIDE";
    emFXCollDyn_S           = "spellFX_Explode_COLLIDEDYNFX";
    emFXCollDynPerc_S       = "VOB_MAGICBURN";
    emFXCollStatAlign_S     = "COLLISIONNORMAL";
    emFXCreatedOwnTrj       = 0;
    emTrjTargetRange        = 20;
    ...
    INSTANCE spellFX_Explode_KEY_OPEN (C_ParticleFXEmitKey)
    {
        lightrange          = 0.01;
    };
    INSTANCE spellFX_Explode_KEY_INIT (C_ParticleFXEmitKey)
    {
        visname_S           = "MFX_Explode_INIT";
        lightrange          = 0.01;
    };
    INSTANCE spellFX_Explode_KEY_CAST (C_ParticleFXEmitKey)
    {
        lightrange          = 100;
        visname_S           = "MFX_Explode_PFXTRAIL";
        emtrjmode_s         = "TARGET";
        emSelfRotVel_S      = "100 100 100";
        emtrjeasevel        = 1400.;
        sfxid               = "MFX_SuckEnergy_Cast";
        sfxisambient        = 1;
        emCreateFXID        = "spellFX_Explode_TRAIL";
        emCheckCollision    = 1;
    };
    INSTANCE spellFX_Explode_KEY_COLLIDE (C_ParticleFXEmitKey)
    {
        pfx_flygravity_s    = "0 0.0002 0";
        emtrjeasevel        = 0.000001;
        sfxid               = "FSB_Attack";
};
INSTANCE spellFX_Explode_TRAIL (CFx_Base_Proto)
{
    emtrjeasevel            = 1400.;
    visname_S               = "MFX_Explode_CAST";
    visAlpha                = 1;
    emtrjmode_s             = "TARGET";
    emtrjtargetnode         = "BIP01 FIRE";
    emtrjloopmode_s         = "NONE";
    ...
    emCheckCollision        = 2;  // 2: Coll, aber keinen Schaden abziehen
    emActionCollDyn_S       = "COLLIDE";
    emActionCollStat_S      = "COLLIDE";
    };
    INSTANCE spellFX_Explode_TRAIL_KEY_COLLIDE (C_ParticleFXEmitKey)
    {
        emtrjeasevel        = 0.000001;
};
INSTANCE spellFX_Explode_COLLIDEDYNFX (CFx_Base_Proto)
{
    visname_S               = "MFX_Fireball_Collide1";
    visAlpha                = 1;
    emTrjOriginNode         = "BIP01";
    emtrjmode_s             = "FIXED";
    lightPresetname         = "FIRESMALL";
    sfxid                   = "MFX_EXPLODE_COLLIDE";
    emfxcreate_s            = "SpellFX_Explode_TARGET";
    emfxcreatedowntrj       = 1;
};
INSTANCE SpellFX_Explode_TARGET (CFx_Base_Proto)
{
    emTrjOriginNode         = "BIP01";
    visname_S               = "MFX_Explode_SPREAD";
    visAlpha                = 1;
    emtrjmode_s             = "FIXED";
    lightpresetname         = "FIRESMALL";
    sfxid                   = "MFX_EXPLODE_SPHERE";
    sfxisambient            = 1;
};
...
INSTANCE spellFX_Earthquake (CFx_Base_Proto)
{
    ...
    emTrjOriginNode         = "ZS_RIGHTHAND";
    emtrjloopmode_s         = "NONE";
    emFXInvestOrigin_S      = "spellFX_Earthquake_BUILDUP"; // SPL_NEXTLEVEL
    };
    INSTANCE spellFX_Earthquake_KEY_CAST (C_ParticleFXEmitKey)
    {
        emCreateFXID        = "spellFX_Earthquake_TARGETS";
        pfx_ppsIsLoopingChg = 1;
...
{
    visName_S               = "spellFX_InvisibleProjectile"; // zSpy umgehen
    sfxid                   = "MFX_EARTHQUAKE_INVEST"; // We only want the sound
};
// Earth Quake FX
INSTANCE spellFX_Earthquake_CAST (CFx_Base_Proto)
{
    ...
    userString[1]           = "8";
    userString[2]           = "7 7 7";
    sfxid                   = "MFX_EARTHQUAKE_RUMBLE";
    sfxIsAmbient            = 1;
};
INSTANCE spellFX_Earthquake_TARGETS (CFx_Base_Proto)
{
    ...
    emFXCollDynAlign_S      = "COLLISIONNORMAL";
    emCheckCollision        = 1;
    emFXCreate_S            = "spellFX_Earthquake_CAST";
    emFXCreatedOwnTrj       = 1;
};
INSTANCE spellFX_Earthquake_SENDPERCEPTION (CFx_Base_Proto) //Sendet perception
{
    sendAssessMagic         = 1;
};
...
INSTANCE spellFX_ManaRecovery (CFx_Base_Proto)
{
    visname_S               = "MFX_ManaRecovery_INIT";
    emtrjoriginnode         = "ZS_RIGHTHAND";
    emtrjmode_s             = "FIXED";
    emtrjloopmode_s         = "NONE";
    emtrjeasefunc_s         = "LINEAR";
    ...
    emtrjdynupdatedelay     = 0.;
    emFXCreate_S            = "spellFX_ManaRecovery_2OBJ";
    emFXInvestOrigin_S      = "spellFX_ManaRecovery_INVEST"; // SPL_NEXTLEVEL
    };
    INSTANCE spellFX_ManaRecovery_KEY_CAST (C_ParticleFXEmitKey)
    {
        visname_S           = "MFX_ManaRecovery_ORIGIN";
        sfxid               = "SFX_HealObsession";
        sfxIsAmbient        = 1;
};
// Rotes "Elekron" auf der Hand
INSTANCE spellFX_ManaRecovery_2OBJ (CFx_Base_Proto)
{
    visname_S               = "MFX_ManaRecovery_INIT2";
    emtrjoriginnode         = "ZS_RIGHTHAND";
    emtrjmode_s             = "FIXED";
    emtrjloopmode_s         = "NONE";
    emtrjeasefunc_s         = "LINEAR";
    ...
    INSTANCE spellFX_ManaRecovery_2OBJ_KEY_INIT (C_ParticleFXEmitKey)
    {
        pfx_ppsisloopingChg  = 1; // Beenden sonst bleibt es nach Zauber
    };
    INSTANCE spellFX_ManaRecovery_2OBJ_KEY_CAST (C_ParticleFXEmitKey)
    {
        pfx_ppsisloopingChg  = 1; // Beenden sonst bleibt es nach Zauber
};
// Investphase
INSTANCE spellFX_ManaRecovery_INVEST (CFx_Base_Proto)
{
    visname_S               = "MFX_ManaRecovery_SPATTER_0";
    emTrjOriginNode         = "BIP01 Spine2";
    emFXCreatedOwnTrj       = 1;
    sfxid                   = "MFX_MANARECOVERY_HEARTBEAT";
    sfxIsAmbient            = 1;
    lightPresetname         = "AURA";
    emFXCreate_S            = "spellFX_ManaRecovery_SPATTER_90";
    emFXLifeSpan            = 30; // Kindersicherung: Falls es hÃ¤ngen bleibt.
};
INSTANCE spellFX_ManaRecovery_SPATTER_90 (CFx_Base_Proto)
{
    visname_S               = "MFX_ManaRecovery_SPATTER_90";
    emTrjOriginNode         = "BIP01 Spine2";
    emFXCreatedOwnTrj       = 1;
    emFXCreate_S            = "spellFX_ManaRecovery_SPATTER_180";
};
INSTANCE spellFX_ManaRecovery_SPATTER_180 (CFx_Base_Proto)
{
    visname_S               = "MFX_ManaRecovery_SPATTER_180";
    emTrjOriginNode         = "BIP01 Pelvis";
    emFXCreatedOwnTrj       = 1;
    emFXCreate_S            = "spellFX_ManaRecovery_SPIRAL";
};
// Spirale in HP-Rot und Mana-Blau um den Caster
INSTANCE spellFX_ManaRecovery_SPIRAL (CFx_Base_Proto)
{
    visname_S               = "MFX_ManaRecovery_RING_LARGE1";
    emTrjOriginNode         = "Bip01";
    emtrjmode_s             = "FIXED";
    emSelfRotVel_S          = "0 400 0";
    emtrjdynupdatedelay     = 0;
    emFXCreatedOwnTrj       = 1;
    emFXCreate_S            = "spellFX_ManaRecovery_SPIRAL2";
};
INSTANCE spellFX_ManaRecovery_SPIRAL2 (CFx_Base_Proto)
{
    visname_S               = "MFX_ManaRecovery_RING_LARGE2";
    emTrjOriginNode         = "Bip01";
    emtrjmode_s             = "FIXED";
    emSelfRotVel_S          = "0 400 0";
    emtrjdynupdatedelay     = 0;
...
INSTANCE spellFX_Extricate (CFx_Base_Proto)
{
    ...
    emtrjloopmode_s         = "NONE";
    emtrjeasefunc_s         = "LINEAR";
    emFXInvestOrigin_S      = "spellFX_Extricate_BUILDUP"; // SPL_NEXTLEVEL
    };
...
INSTANCE spellFX_Extricate_CAST (CFx_Base_Proto)
{
    ...
    emFXCreatedOwnTrj       = 1;
    emActionCollDyn_S       = "CREATE COLLIDE"; // Erreiche alle
...
INSTANCE spellFX_Extricate_SENDPERCEPTION (CFx_Base_Proto)  // Send perception
{
    visname_S               = "";
    sendAssessMagic         = 1;
};
...
INSTANCE spellFX_Extricate_PreRumble (CFx_Base_Proto)
{
    visName_S               = "earthquake.eqk";
    userString[0]           = "500";
    userString[1]           = "0";  // Nicht Ã¤ndern, sonst kommt es zwei mal
    userString[2]           = "4 4 4";
};
